...
public class DevicePointMap_PLC_RanYouZhengQi extends DevicePointMap {
    ...
    public DevicePointMap_PLC_RanYouZhengQi() {
        ...
        map.put("_jienengbeng", ByteField.Init(new DeviceField(), "_jienengbeng", 0, 0, "Energy-Saving Pump", false));
        map.put("_chuanyangbeng", ByteField.Init(new DeviceField(), "_chuanyangbeng", 0, 0, "De-aerator Pump", false));
        map.put("_zhaoqifan", ByteField.Init(new DeviceField(), "_zhaoqifan", 0, 0, "Biogas Blower", false));
