...
public class DevicePointMap_PLC_RanMeiZhengQi extends DevicePointMap {
    ...
    public DevicePointMap_PLC_RanMeiZhengQi()
    {
        ...
        map.put(Device_PLC.KEY_POINT_CHU_YANG_BENG, ByteField.Init(new CountField(), Device_PLC.KEY_POINT_CHU_YANG_BENG,  "除氧泵"));
        map.put(Device_PLC.KEY_POINT_GU_FENG_FAN, ByteField.Init(new CountField(), Device_PLC.KEY_POINT_GU_FENG_FAN,  "鼓风"));
        map.put(Device_PLC.KEY_POINT_YIN_FENG_FAN, ByteField.Init(new CountField(), Device_PLC.KEY_POINT_YIN_FENG_FAN, "引风"));
        map.put(Device_PLC.KEY_POINT_LU_PAI_FAN, ByteField.Init(new CountField(), Device_PLC.KEY_POINT_LU_PAI_FAN, "炉排"));
        map.put(Device_PLC.KEY_POINT_CHU_ZHA_FAN, ByteField.Init(new CountField(), Device_PLC.KEY_POINT_CHU_ZHA_FAN,"出渣"));
        ...
        map.put(SdcSoftDevice.KEY_POINT_POWER, ByteField.Init(new FixedValueField(), SdcSoftDevice.KEY_POINT_POWER,  "燃料",2,DevicePointMap.coms_power));
        ...
        map.put(KEY_POINT_YIN_FENG_FAN_1, ByteField.Init(new DeviceField(), KEY_POINT_YIN_FENG_FAN_1, 370, 2, "引风", DevicePointMap.coms_start_stop));
        map.put("de_gufeng_auto", ByteField.Init(new DeviceField(), "de_gufeng_auto", 372, 2, "鼓风",PLC_Common_ValueMaps.coms_atuo));
        map.put(KEY_POINT_GU_FENG_FAN_1, ByteField.Init(new DeviceField(), KEY_POINT_GU_FENG_FAN_1, 374, 2, "鼓风", DevicePointMap.coms_start_stop));
        map.put("de_lupai_auto", ByteField.Init(new DeviceField(), "de_lupai_auto", 376, 2, "炉排",PLC_Common_ValueMaps.coms_atuo));
        map.put(KEY_POINT_LU_PAI_FAN_1, ByteField.Init(new DeviceField(), KEY_POINT_LU_PAI_FAN_1, 378, 2, "炉排", DevicePointMap.coms_start_stop));
        map.put("de_chuzha_auto", ByteField.Init(new DeviceField(), "de_chuzha_auto", 380, 2, "除渣",PLC_Common_ValueMaps.coms_atuo));
        map.put(KEY_POINT_CHU_ZHA_FAN_1, ByteField.Init(new DeviceField(), KEY_POINT_CHU_ZHA_FAN_1, 382, 2, "除渣", DevicePointMap.coms_start_stop));
        ...
        map.put(KEY_POINT_Add_SHUI_BENG_1, ByteField.Init(new DeviceField(), KEY_POINT_Add_SHUI_BENG_1, 386, 2, "1#给水泵", DevicePointMap.coms_start_stop));
        ...
        map.put(KEY_POINT_Add_SHUI_BENG_2, ByteField.Init(new DeviceField(), KEY_POINT_Add_SHUI_BENG_2, 390, 2, "2#给水泵", DevicePointMap.coms_start_stop));
        ...
        map.put(KEY_POINT_CHU_YANG_BENG_1, ByteField.Init(new DeviceField(), KEY_POINT_CHU_YANG_BENG_1, 394, 2, "1#除氧泵", DevicePointMap.coms_start_stop));
        ...
        map.put(KEY_POINT_CHU_YANG_BENG_2, ByteField.Init(new DeviceField(), KEY_POINT_CHU_YANG_BENG_2, 398, 2, "2#除氧泵", DevicePointMap.coms_start_stop));
