...
public class DevicePointMap_CTL_NJRT_E3_DianReShui extends DevicePointMap {
    ...
    public DevicePointMap_CTL_NJRT_E3_DianReShui() {
        ...
        map.put(KEY_POINT_RUN_LIFE, ByteField.Init(new BaseInfoField(), KEY_POINT_RUN_LIFE, 21, 2, "运行时间"));

        map.put(KEY_POINT_RUN_DAYS, ByteField.Init(KEY_BASE, new CountShowField(), KEY_POINT_RUN_DAYS, "运行天数", "天"));
