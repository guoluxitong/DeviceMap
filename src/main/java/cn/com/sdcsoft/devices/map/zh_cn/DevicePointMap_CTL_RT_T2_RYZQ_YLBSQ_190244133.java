...
public class DevicePointMap_CTL_RT_T2_RYZQ_YLBSQ_190244133 extends DevicePointMap_CTL_RT_T2_RYZQ {
    public static final String Key = "CTL_RT_T2_RYZQ_YLBSQ_190244133";
//01030010003445d8
    public DevicePointMap_CTL_RT_T2_RYZQ_YLBSQ_190244133() {
        ...
        map.put(KEY_POINT_LENG_NING_BENG, ByteField.Init(new CountField(), KEY_POINT_LENG_NING_BENG, "节能循环泵"));
        ...
        map.put("oc_yalikongzhiqi1", ByteField.Init(new OpenCloseField(), "oc_yalikongzhiqi1", 5, 2, "压力控制器（一段火）",7,coms_open_close));
        map.put("oc_yalikongzhiqi2", ByteField.Init(new OpenCloseField(), "oc_yalikongzhiqi2", 5, 2, "压力控制器（二段火）",8,coms_open_close));
        ...
        map.put(KEY_POINT_LENG_NING_BENG_1, ByteField.Init(new DeviceField(), KEY_POINT_LENG_NING_BENG_1, 9, 2, "节能循环泵控制",5,coms_open_close));
        ...
        map.put("ex_ranqiyaligaobaojing", ByteField.Init(new ExceptionField(), "ex_ranqiyaligaobaojing", 47, 2, "燃气压力高报警",0));
        map.put("ex_ranqixieloubaojing", ByteField.Init(new ExceptionField(), "ex_ranqixieloubaojing", 47, 2, "燃气泄漏报警",1));
        map.put("ex_ranshaoqiguzhang", ByteField.Init(new ExceptionField(), "ex_ranshaoqiguzhang", 47, 2, "燃烧器故障",2));
    }
}
