...
import static cn.com.sdcsoft.devices.Device_CTL_RT_T2.KEY_POINT_Add_SHUI_BENG_2;
import static cn.com.sdcsoft.devices.Device_CTL_RT_T2.KEY_POINT_LENG_NING_BENG_1;
...
public class DevicePointMap_CTL_RT_T2_RYZQ_YLBSQ extends DevicePointMap_CTL_NJRT_T2 {
    public static final String Key = "CTL_RT_T2_RYZQ_YLBSQ";
    static final String Commands_Key_Parameters_Setting = "参数设置";
    static final String Commands_Key_System_Ctl = "系统控制";


    public DevicePointMap_CTL_RT_T2_RYZQ_YLBSQ() {
        ...
        map.put("_ranshaoqi", ByteField.Init(new CountField(), KEY_POINT_RAN_SHAO_QI, "Burner"));
        map.put("_addshuibeng", ByteField.Init(new CountField(), KEY_POINT_Add_SHUI_BENG,  "Water Feeding Pump"));
        map.put("_lengningbeng", ByteField.Init(new CountField(),KEY_POINT_LENG_NING_BENG,"Condensation Pump"));
        ...
        map.put("oc_queshuidianji2", ByteField.Init(new OpenCloseField(), "oc_queshuidianji2", 5, 2, "Lack of water electrode2",7,coms_open_close));
        ...
        map.put(KEY_POINT_RAN_SHAO_QI_STATUS, ByteField.Init(new OpenCloseField(), KEY_POINT_RAN_SHAO_QI_STATUS, 0, 0, "Burner regulation",coms_ranshaoqi_status));

        map.put("oc_ranshaoqifuhediaojie/zengdadiaojie", ByteField.Init(new OpenCloseField(), "oc_ranshaoqifuhediaojie/zengdadiaojie", 9, 2, "Burner load increase adjustment",1));
        map.put("oc_jianxiaodiaojie", ByteField.Init(new OpenCloseField(), "oc_jianxiaodiaojie", 9, 2, "Reduce the adjustment",2));
        ...
        map.put("ex_yalibiansongqiduanlu1", ByteField.Init(new ExceptionField(), "ex_yalibiansongqiduanlu1", 45, 2, "Break of pressure transmitter",0));
        map.put("ex_yalibiansongqiduanlu", ByteField.Init(new ExceptionField(), "ex_yalibiansongqiduanlu", 45, 2, "Short circuit of pressure transmitter",1));
        map.put("ex_chaoyabaojing_biansongqi_", ByteField.Init(new ExceptionField(), "ex_chaoyabaojing_biansongqi_", 45, 2, "Overpressure alarm (transmitter)",2));
