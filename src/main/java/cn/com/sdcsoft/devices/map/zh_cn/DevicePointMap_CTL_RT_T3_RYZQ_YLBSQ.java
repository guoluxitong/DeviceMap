...
import static cn.com.sdcsoft.devices.Device_CTL_RT_T3.*;
import static cn.com.sdcsoft.devices.map.zh_cn.DevicePointMap.CTL_NJRT_Common_ValueMaps.*;

//01030010002ac5d0
public class DevicePointMap_CTL_RT_T3_RYZQ_YLBSQ extends DevicePointMap_CTL_RT_T3_RYZQ {
    public static final String Key = "CTL_RT_T3_RYZQ_YLBSQ";
    public DevicePointMap_CTL_RT_T3_RYZQ_YLBSQ() {
        ...
        map.put(KEY_POINT_RAN_SHAO_QI_KONGZHI, ByteField.Init(new OpenCloseField(), KEY_POINT_RAN_SHAO_QI_KONGZHI, 9, 2, "燃烧器启停控制",coms_open_close));
        ...
        map.put(KEY_POINT_Add_SHUI_BENG_1, ByteField.Init(new OpenCloseField(), KEY_POINT_Add_SHUI_BENG_1, 9, 2, "给水泵控制（主）",3,coms_open_close));
        map.put(KEY_POINT_Add_SHUI_BENG_2, ByteField.Init(new OpenCloseField(), KEY_POINT_Add_SHUI_BENG_2, 9, 2, "给水泵控制（备）",4,coms_open_close));
        map.put(KEY_POINT_LENG_NING_BENG_1, ByteField.Init(new OpenCloseField(), KEY_POINT_LENG_NING_BENG_1, 9, 2, "冷凝循环泵控制",5,coms_open_close));
        map.put("oc_baojingzhuangtaishuchu", ByteField.Init(new OpenCloseField(), "oc_baojingzhuangtaishuchu", 9, 2, "报警状态输出",8,coms_open_close));
        ...
        map.put("de_lengningxunhuanbeng_zidong/shoudong_", ByteField.Init(new DeviceField(), "de_lengningxunhuanbeng_zidong/shoudong_", 49, 2, "冷凝循环泵",3, coms_master));
