...
public class DevicePointMap_CTL_NJZJ_IP_458 extends DevicePointMap {
    static final String Commands_Key_Parameters_Setting = "参数设置";
    static final String Commands_Key_System_Ctl = "系统控制";

    public DevicePointMap_CTL_NJZJ_IP_458() {
        commandsMap.put(Commands_Key_Parameters_Setting,null);
        commandsMap.put(Commands_Key_System_Ctl,null);

        //基本信息 010306000028455C
        map.put(SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, ByteField.Init(new SystemStatusField(), SdcSoftDevice.KEY_POINT_SYSTEM_STATUS, 7, 2, "系统状态", CTL_NJZJ_Common_ValueMaps.coms_status, Commands_Key_System_Ctl, "0602", 1, 2));
        ...
        map.put(SdcSoftDevice.KEY_POINT_POWER, ByteField.Init(new BaseInfoField(), SdcSoftDevice.KEY_POINT_POWER, 3, 2, "燃料类型", coms_power));

        map.put(SdcSoftDevice.KEY_POINT_MEDIA, ByteField.Init(new BaseInfoField(), SdcSoftDevice.KEY_POINT_MEDIA, 5, 2, "介质类型", coms_media));
        ...
        //
        map.put("se_paiyanbaojingwendu", ByteField.Init(new SettingField(), "se_paiyanbaojingwendu", 1068, 2, "排烟报警温度", "℃", Commands_Key_Parameters_Setting, "0500", 50, 300));
        map.put("se_baojingwendu", ByteField.Init(new SettingField(), "se_baojingwendu", 1070, 2, "报警温度", "℃", Commands_Key_Parameters_Setting, "0501", 0, 200));
        map.put("se_tingluwendu", ByteField.Init(new SettingField(), "se_tingluwendu", 1072, 2, "停炉温度", "℃", Commands_Key_Parameters_Setting, "0502", 30, 200));
        map.put("se_mubiaowendu", ByteField.Init(new SettingField(), "se_mubiaowendu", 1074, 2, "目标温度", "℃", Commands_Key_Parameters_Setting, "0503", 30, 200));
        map.put("se_qiluwendu", ByteField.Init(new SettingField(), "se_qiluwendu", 1076, 2, "启炉温度", "℃", Commands_Key_Parameters_Setting, "0504", 0, 200));
        map.put("se_zhuanhuohuicha", ByteField.Init(new SettingField(), "se_zhuanhuohuicha", 1078, 2, "转火回差", "℃"));
        map.put("se_qiluhuicha", ByteField.Init(new SettingField(), "se_qiluhuicha", 1080, 2, "启炉回差", "℃", Commands_Key_Parameters_Setting, "0506", 1, 100));
        map.put("se_kaibengwendu", ByteField.Init(new SettingField(), "se_kaibengwendu", 1082, 2, "开泵温度", "℃", Commands_Key_Parameters_Setting, "0507", 0, 200));
        map.put("se_guanbengwendu", ByteField.Init(new SettingField(), "se_guanbengwendu", 1084, 2, "关泵温度", "℃", Commands_Key_Parameters_Setting, "0508", 0, 200));
        ...
        map.put("se_touqieshijian_jiarezuyong_", ByteField.Init(new SettingField(), "se_touqieshijian_jiarezuyong_", 1210, 2, "投切时间（加热组用）", "s", Commands_Key_Parameters_Setting, "0547", 1, 10));
        map.put("se_diaojieshijian_jiarezuyong_", ByteField.Init(new SettingField(), "se_diaojieshijian_jiarezuyong_", 1212, 2, "调节时间（加热组用）", "m", Commands_Key_Parameters_Setting, "0548", 1, 10));
