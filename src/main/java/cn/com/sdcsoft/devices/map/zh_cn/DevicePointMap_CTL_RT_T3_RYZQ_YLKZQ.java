...
//01030010002ac5d0
public class DevicePointMap_CTL_RT_T3_RYZQ_YLKZQ extends DevicePointMap_CTL_RT_T3_RYZQ {
    public static final String Key = "CTL_RT_T3_RYZQ_YLKZQ";
    public DevicePointMap_CTL_RT_T3_RYZQ_YLKZQ() {
        ...
        map.put("de_lengningxunhuanbeng_zidong/shoudong_", ByteField.Init(new DeviceField(), "de_lengningxunhuanbeng_zidong/shoudong_", 49, 2, "节能循环泵",3, coms_master));
