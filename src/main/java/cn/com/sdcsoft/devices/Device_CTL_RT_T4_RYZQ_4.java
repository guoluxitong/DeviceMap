...
public class Device_CTL_RT_T4_RYZQ_4 extends Device_CTL_RT_T4_RYZQ {
    public Device_CTL_RT_T4_RYZQ_4() {
    ...
    public List<DeviceFieldForUI> getDeviceFocusFields() {
        ...
        list.add(getUiItem(this.getMockFields(), "mo_zhengqiwendu"));
        list.add(getUiItem(this.getMockFields(), "mo_qibaoshuiwei"));
        return list;
    }
}
