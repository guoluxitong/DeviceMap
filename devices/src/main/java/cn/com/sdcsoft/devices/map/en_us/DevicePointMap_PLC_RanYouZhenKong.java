...
public class DevicePointMap_PLC_RanYouZhenKong extends DevicePointMap {
    ...
    public DevicePointMap_PLC_RanYouZhenKong() {
        ...
        map.put("_addshuibeng", ByteField.Init(new DeviceField(), "_addshuibeng", 0, 0, "Feed water pump", false));
        map.put("_zhenkongbeng", ByteField.Init(new DeviceField(), "_zhenkongbeng", 0, 0, "Vacuum pump", false));
        ...
        map.put(SdcSoftDevice.KEY_POINT_MEDIA, ByteField.Init(new MediaField(), SdcSoftDevice.KEY_POINT_MEDIA, 4, 0, " Medium",DevicePointMap.coms_media));
